 ...
 *
 * This component renders a circular loading spinner with optional additional styling
 * via the `className` prop. It includes an accessible label for screen readers.
 *
 * @component
 * @param {ISpinnerProps} props - Component props.
